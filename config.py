...
plugin_prefs = JSONConfig('plugins/' + STORE_NAME)
...
class ConfigWidget(DefaultConfigWidget):
    ...
    def __init__(self, plugin):
        ...
        max_label.setToolTip(
            'Kyobobook do not always have links to large covers for every ISBN\n'
        ...
        self.get_category_checkbox.setToolTip(
            'Add Kyobobook Categories to Calibre tags'
            '(ex, [Domestic Books > History > Korea Culture / History Journey]).')
        ...
        self.all_authors_checkbox.setToolTip(
            'Kyobobook for some books will list all of the contributing authors and\n'
        ...
        self.toc_checkbox.setToolTip(
            'Kyobobook for textbooks on their website have a Features tab which\n'
